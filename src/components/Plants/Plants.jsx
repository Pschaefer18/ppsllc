...
<link href="https://fonts.googleapis.com/css2?family=Titillium+Web:wght@900&display=swap" rel="stylesheet" />
      <div className="plants-heading">
        <h1 style={{textAlign: 'center', color: 'white', fontWeight: 'bold', fontSize: '8vh'}}>Plants</h1>
        ...
        <div className="row row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 g-4">
          {plants.map((plant) => (
            <div key = {plant.id} className="plant-card">
              ...
              {(plant.status === "Pre-Order") && <h3 style={{fontSize: 28, fontFamily: "Titillium Web", fontWeight: 900, color: 'white'}}>Pre-Order</h3>}
              {(plant.status === "In Stock") && <h3 style={{fontSize: 28, fontFamily: "Titillium Web", fontWeight: 900, color: 'white'}} className="text-success">Available Now</h3>}
